      ...
      <div style={styles.container}>
        ...
        <div style={styles.card}>
          <div style={styles.field}>
            ...
            <input style={styles.input} placeholder="contoh: Jual sepatu sneakers limited edition" value={topik} onChange={(e) => setTopik(e.target.value)} onKeyDown={(e) => e.key === "Enter" && generate()} />
          </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  input: { width: "100%", padding: "10px 14px", borderRadius: 10, border: "1.5px solid #e5e7eb", fontSize: 14, color: "#1a1a2e", background: "#fff" },
